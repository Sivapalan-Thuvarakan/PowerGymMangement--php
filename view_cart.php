...
<div class="container">
  <div class="row">
			...
			<a href='viewCartProduct.php'>View Cart</a>
			<?php 
			if(isset($_POST["addCart"])){
				if(isset($_SESSION["cart"]))
				{
					...
					if(!in_array($_GET["id"],$pid_array))
					{
						...
						header("location:viewCartProduct.php");
					}
					else
					{
            ...
            $id=$_GET["id"];
			$sql="select * from cartproduct where PID='$id'";
			$res=$db->query($sql);
			if($res->num_rows>0)
			{
			...
			echo  '
				<div class="col-sm-4 col-lg-3 col-md-3 text-center">    
					...
					<p>Brand : '. $row['BRANDNAME'] .'</p>
					<p>RAM : '. $row['RAM'] .' GB</p>
					<p>Storage : '. $row['ROM'] .' GB </p>
